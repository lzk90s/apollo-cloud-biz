 ...
 */
@Data
public class PublishConfigModifyCmd {
    @NotNull
    private Long id;
    /**
     * name
    ...
    public static BeanConverter<PublishConfigModifyCmd, PublishConfigDO> convertPublishConfigEntity() {
        return BeanConverter.of(PublishConfigModifyCmd.class, PublishConfigDO.class);
    }
}
