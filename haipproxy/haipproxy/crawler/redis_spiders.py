...
class RedisMixin(object):
    ...
    def next_requests(self):
        ...
        get_total = self.redis_con.scard if self.use_set else self.redis_con.llen
        found = 0
        ...
        crawler_logger.info('Read {} requests from {}, total {}'.format(found, self.task_queue,
                                                                        get_total(self.task_queue)))
    ...
    def next_requests_process(self, task_queue):
        ...
        while found < self.redis_batch_size:
            ...
            for url in self.urls:
                ...
                yield req
                found += 1
        crawler_logger.info('Read {} ip proxies from {}, total {}'.format(found, task_queue, get_total(task_queue)))
